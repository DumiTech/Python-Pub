...
def check_coins(quarters, dimes, nickels, pennies, desired_item, request):
    ...
    inserted_coins = round(quarters * coins_values['quarter'] + dimes * coins_values['dime'] + nickels * coins_values['nickel'] + pennies * coins_values['penny'], 3)
